...
class RoutesController: ObservableObject {
   ...
   func formatRawRouteVariant(rawVariant: APIRouteVariant, isCircular: Bool) -> Variant {
      ...
      print("GB SHAPE: \(String(describing: rawVariant.upItinerary?.shape))")
      print("GB SHAPE: \(String(describing: rawVariant.downItinerary?.shape))")
      print("GB SHAPE: \(String(describing: rawVariant.circItinerary?.shape))")
